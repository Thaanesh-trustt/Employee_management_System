...
export const Attendance = (props) => {
  ...
  return (
	...
	<div className="container " style={{ height: "100%", width: "85%" }}>
      <div className="d-flex justify-content-between">
        <h1 >Attendance</h1>
        <button className="me-2 btn btn-primary btn-sm">My Regularizations</button>
      </div>
	  <hr />
      ...
      <div className="p-3 d-flex justify-content-around mt-3">
      <div className="me-2 container" style={{ display: "flex", flexDirection: "column"}}>
    ...
    <div className="me-2 container" style={{ width: "200px", display: "flex", flexDirection: "column"}}>
      ...
      <tbody>
        {attendance.map((item, index) => (
          <tr key={index}>
            ...
            <td>{item.breakHrs}</td>
            <td>{item.actualWorkHrs}</td>
            <td>{item.workHrsInShiftTime}</td>
            <td>{item.shortfallHrs}</td>
            <td>{item.excessHrs}</td>
          </tr>
        ))}
      </tbody>
    </table>
